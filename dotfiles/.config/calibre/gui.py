...
# 主窗口位置尺寸
main_window_geometry = cPickle.loads('\x80\x02cPyQt5.sip\n_unpickle_type\nq\x01U\x0cPyQt5.QtCoreq\x02U\nQByteArrayUB\x01\xd9\xd0\xcb\x00\x03\x00\x00\x00\x00\x03\x89\x00\x00\x01,\x00\x00\x07|\x00\x00\x044\x00\x00\x03\x89\x00\x00\x01Q\x00\x00\x07|\x00\x00\x044\x00\x00\x00\x00\x00\x00\x00\x00\x07\x80\x00\x00\x03\x89\x00\x00\x01Q\x00\x00\x07|\x00\x00\x044\x85\x87Rq\x03.')
...
# gui layout
# 用户界面的布局。宽表示在右侧显示书的详述面板而窄是显示在底部。
gui_layout = 'wide'
